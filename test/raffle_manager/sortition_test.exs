defmodule RaffleManager.SortitionTest do
  ...
  describe "sort" do
    ...
    test "create_sort/1 with valid data creates a sort" do
      date_now = DateTime.utc_now() |> DateTime.truncate(:second) |> to_string()
      {:ok, date_str, _} = date_now |> DateTime.from_iso8601()
      ...
      assert sort.date_limit == date_str
  ...
  describe "sort_number" do
    ...
    test "update_sort_number/2 with valid data updates the sort_number" do
      ...
      assert {:ok, %SortNumber{} = sort_number} =
               Sortition.update_sort_number(sort_number, update_attrs)
    ...
    test "update_sort_number/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Sortition.update_sort_number(sort_number, @invalid_attrs)
